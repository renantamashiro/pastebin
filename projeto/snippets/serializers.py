...
class TravelSerializer0(serializers.ModelSerializer):
    owner = serializers.ReadOnlyField(source='owner.username')
...
class UserTravelSerializer0(serializers.ModelSerializer):
...
class TravelSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Travel
        fields = ['url', 'id', 'location', 'description', 'country', 'date_travel', 'owner']

class UserTravelSerializer(serializers.HyperlinkedModelSerializer):
